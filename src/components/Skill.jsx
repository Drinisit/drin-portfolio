...
const Skill = () => {
  return (
    <div className='w-full bg-gray-200 py-16 px-6'>
            <div className='max-w-[1240px] mx-auto grid xxs:grid-cols-2 md:grid-cols-3 xxs:gap-3 xs:gap-5 md:gap-8'>
